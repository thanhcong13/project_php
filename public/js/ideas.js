...
$(document).ready(function () {
  ...
  imageInput.on("change", function (event) {
    ...
    if (files && files.length > 0) {
      $.each(files, function (index, file) {
        ...
        var currentImages = previewContainer.children(".col-md-6, .col-md-12").length;
        var columnClass = currentImages + 1 === 1 ? "col-md-12" : "col-md-6";

        // Tạo phần tử chứa ảnh
        var imageWrapper = $("<div>", {
          "class": "".concat(columnClass, " mb-1"),
          css: {
            position: "relative"
          }
        });
        ...
        deleteBtn.on("click", function () {
          ...
          var remainingImages = previewContainer.children(".col-md-6, .col-md-12");
          remainingImages.removeClass("col-md-12 col-md-6");
          remainingImages.each(function (i, elem) {
            var newClass = remainingImages.length === 1 ? "col-md-12" : "col-md-6";
  ...
  $("#submit-idea").on("click", function () {
    var ideaContent = $("#idea").val();
    var files = $("#images")[0].files;
    var images = [];
    var url = $("#create-idea").data("url-idea");
